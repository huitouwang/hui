...
<%--sortDrag--%>
<div class="pageContent" style="border:1px #B8D0D6 solid;background: white;" >
...
<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:100px">
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">投资者管理费用总额：<fmt:formatNumber value="${obj[5]}" type="currency"/>元</div>
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">借款者管理费用总额：<fmt:formatNumber value="${obj[6]}" type="currency"/>元</div>
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">VIP费用总额：<fmt:formatNumber value="${obj[7]}" type="currency"/>元</div>
</div>
<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:100px">
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">成功借款总额：<fmt:formatNumber value="${obj[2]}" type="currency"/>元</div>
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">借款投标奖励总额：<fmt:formatNumber value="${obj[3]}" type="currency"/>元</div>
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">推广奖金：<fmt:formatNumber value="${obj[4]}" type="currency"/>元</div>
</div>
...
<h3 style="width:31%;margin:5px;float: left;">&nbsp;</h3>
<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;">
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">线上充值：<fmt:formatNumber value="${obj[8]}" type="currency"/>元</div>
</div>
<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;">
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">成功提现：<fmt:formatNumber value="${obj[9]}" type="currency"/>元</div>
</div>
		...
		<div class="tabsContent" style="height:150px;">
			...
			<div>
				<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:100px">
					...
					<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">已还本金：<fmt:formatNumber pattern="0.00" value="${type1[1]}"/></div>
			...
			<div>
				<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:100px">
					...
					<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">已还本金：<fmt:formatNumber pattern="0.00" value="${type2[1]}"/></div>
			...
			<div>
				<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:100px">
					...
					<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">已还本金：<fmt:formatNumber pattern="0.00" value="${type3[1]}"/></div>
			...
			<div>
				<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:100px">
					...
					<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">已还本金：<fmt:formatNumber pattern="0.00" value="${type4[1]}"/></div>
			...
			<div>
				<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:100px">
					...
					<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">已还本金：<fmt:formatNumber pattern="0.00" value="${second[1]}"/></div>
