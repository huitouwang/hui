...
<table class="table" width="100%"  rel="jbsxBox" layoutH="101">
	...
	<c:forEach items="${list}" var="accinfo">
		<tr  style="cursor: pointer;">
			<td>${accinfo[1]}</td>
			<td>${accinfo[2]}</td>
			<td><fmt:formatNumber value="${accinfo[3]}" pattern="#0.00"/></td>
			<td><fmt:formatNumber value="${accinfo[4]}" pattern="#0.00"/></td>
			<td><fmt:formatNumber value="${accinfo[5]}" pattern="#0.00"/></td>
		</tr>
	</c:forEach>
	</tbody>
</table>
