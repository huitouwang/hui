...
$(function(){
	...
	$("#loginout").click(function(){
		alertMsg.confirm('是否安全退出系统?', {okCall: function(){window.location.href="<%=basePath%>adminuser/loginout";}
      });
	});
			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
					<div class="accordionHeader">
						<h2><span>Folder</span>P2P网贷平台</h2>
					</div>
				...
				<div id="mainpage" class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="accountInfo">
							<p><span>P2P网贷平台投资管理平台</span></p>
							<p>P2P网贷平台首页:<a href="#" target="_blank">(*^__^*) </a></p>
						</div>
