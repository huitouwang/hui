...
<div layoutH="0" class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="delete" id="deleteAll" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="icon" id="FBloansign"><span>发布</span> </a></li>
			<li><a class="icon" id="FKloansign"><span>放款</span> </a></li>
			<li><a class="icon" id="LBloansign"><span>流标</span> </a></li>
	...
	<div id="search-panel">
		<div>
			<form method="post" id="searchfrom">
				...
				<input id="loanCategory" style="width: 90px" name="loanType" />
