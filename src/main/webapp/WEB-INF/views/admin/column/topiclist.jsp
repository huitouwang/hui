...
<div class="panelBar">
		<ul class="toolBar">
		<li><a class="edit" href="/topic/forwardAddOrUpt?operation=upt&topicId={topic_id}" target="dialog" rel="addusertab" mask="true" maxable="false" resizable="false"  warn="请选择您要修改的一级栏目！" width="520" height="215"><span>编辑</span></a></li>
		<li><a class="add" href="/topic/forwardAddOrUpt?operation=add&topicId=0" target="dialog" rel="addusertab" mask="true" maxable="false" resizable="false" width="520" height="215"><span>新增</span></a></li>
