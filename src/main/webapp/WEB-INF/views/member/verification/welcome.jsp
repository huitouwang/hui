...
<div id="MyDiv" class="white_content" style="width: 642px;">
	...
	<div class="white_d pad_b" style="width: 632px;">
		<div class="notice_t">
			<span class="fl">P2P网贷平台安全验证</span> <span class="fr"
		...
		<table border="0" align="center"
			...
			<tr valign="top">
				...
				<td style="font-size: 12px;">亲爱的<font color="#dd0000">【${empty session_user.userName ? 'P2P网贷平台用户':session_user.userName}】</font>，您好，欢迎注册P2P网贷平台！<br />
					为了保证您的账户安全，请先完成P2P网贷平台的安全验证流程。
		...
		<p style="padding: 0px 30px;">
			注意事项：<br /> 1、P2P网贷平台暂不提供个人消费贷款担保。
<!-- 			<br /> 2、如果您是贷款经商者，请先阅读<a href="#" style="color: #2ca3eb;">【借入要求】</a>（必须）。<br /> -->
			<br/>
			2、如果您在验证过程中，出现任何问题，请致电 <font color="#dd0000">(*^__^*) </font> 。
