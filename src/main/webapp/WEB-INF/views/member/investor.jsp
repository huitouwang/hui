...
<h1 class="vipContTitle"><span><img src="resources/images/vipseversicon.png" /></span>尊敬的p2p网用户，以下是您在p2p网的回款计划，按照还款日期排列。</h1>
<p>您目前待收的本息总额是：<font>￥${allMonth }</font>未扣除佣金，共<font>${investment_count }</font>笔投资</p>
</div>
