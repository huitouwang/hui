...
<body>
				...
				<div class="vipRightBox">
					<div class="vipHeadMenuBox">
						<ul>
							...
							<li><a href="<%=basePath%>depositshistory/init_seven"
								class="vipHeadLink">已还清项目</a></li>
						</ul>
					</div>
					<!--vipContBox-->
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="../resources/images/vipseversicon.png" /></span>尊敬的p2p网用户，以下是您在p2p网的已还清项目。
							</h1>
							<p>
								您目前的已收总额是：<font><fmt:formatNumber value="${count_money}" type="currency"/></font>，共 <font>${count}</font>笔已收。
							</p>
						</div>
						<form>
	                		...
	                		<fmt:formatDate pattern="yyyy-MM-dd" value="${cur_date}" /></td>
										<td><fmt:formatNumber value="${loann.tenderMoney}" type="currency"/></td>
										<td><fmt:formatNumber value="${loann.principalandInterest}" type="currency"/></td>
										<td><fmt:formatNumber value="${loann.realTotal}" type="currency"/></td>
									</tr>
									</c:forEach>
								</tbody>
								<tfoot>
	...
	<script type="text/javascript">
		function jumpPage(pageno){
			...
			fn_ajax("<%=basePath%>depositshistory/init_seven?no="+pageno);
		}
		function jumpPage02(){
