					...
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="../resources/images/vipseversicon.png" /></span>尊敬的p2p网用户，以下是您在p2p网的收款项目。
							</h1>
							<p>
								您目前收款总额是：<font><fmt:formatNumber value="${count_money}" type="currency"/></font>，共 <font>${count}</font> 笔收款。
							</p>
						</div>
						<form>
