					...
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="../resources/images/vipseversicon.png" /></span>尊敬的p2p网用户，以下是您在p2p网的未收款明细。
							</h1>
							<p>
								您目前的未收款总额是：<font><fmt:formatNumber value="${count_money}" type="currency"/></font>，共 <font>${count}</font> 笔收款。
							</p>
						</div>
						<form>
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<c:forEach items="${loannlist}" var="loann">
									<tr>
										...
										<td><fmt:formatNumber value="${loann.total}" type="currency"/>	</td>
