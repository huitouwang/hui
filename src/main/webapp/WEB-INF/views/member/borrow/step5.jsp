...
<h1 class="vipContTitle"><span><img src="../resources/images/vipseversicon.png" /></span>通过提交您的联保情况，p2p网将进行初步审核。</h1>
</div>
...
<table cellpadding="0" cellspacing="0" border="0" class="creditData">
 <tbody>
							...
							<tr height="35">
								...
								<td><input type="text"" value="${othercontact.linkman1 }" name="linkman1" class="credit validate[custom[onlyUnSpecial]]" id="linkman1"
							...
							<tr height="35">
								...
								<td><input type="text" value="${othercontact.linkman2 }" name="linkman2" id="linkman2" class="credit validate[custom[onlyUnSpecial]]"
									style="width: 155px;" /></td>
							</tr>
							<tr height="35">
								<td align="right">关系：</td>
