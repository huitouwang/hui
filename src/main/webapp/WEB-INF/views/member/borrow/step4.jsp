					...
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="../resources/images/vipseversicon.png" /></span>通过提交您的财务状况，p2p网将进行初步审核。
							</h1>
						</div>
						<form action="../borrow/updateFinanes" method="post"
							...
							<tr height="120">
								...
								<td style="padding-left: 5px;"><textarea cols="70" rows="8" name="incomeRemark"
										id="incomeRemark" class="validate[custom[onlyUnSpecial]]">${finanes.incomeRemark }</textarea></td>
							</tr>
							<tr height="35">
							...
							<tr height="120">
								...
								<td style="padding-left: 5px;"><textarea cols="70" rows="8" name="payRemark"
										id="payRemark" class="validate[custom[onlyUnSpecial]]">${finanes.payRemark }</textarea></td>
							</tr>
							<tr height="35">
							...
							<tr height="35">
								...
								<td style="padding-left: 5px;"><input type="text"
									...
									class="credit validate[custom[onlyUnSpecial]]" /></td>
							</tr>
							<tr height="35">
							...
							<tr height="120">
								...
								<td style="padding-left: 5px;"><textarea cols="70" rows="8" name="otherPropertyDescribe"
										id="otherPropertyDescribe" class="validate[custom[onlyUnSpecial]]">${finanes.otherPropertyDescribe }</textarea></td>
							</tr>
								</tbody>
							</table>
