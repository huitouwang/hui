					...
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="../resources/images/vipseversicon.png" /></span>通过提交您的联系方式，p2p网将进行初步审核。
							</h1>
						</div>
								...
								<tbody>
									<tr>
										...
										<td><input id="newaddress" name="newaddress" type="text"
											value="${contact.newaddress }" class="credit validate[custom[onlyUnSpecial]]"
									...
									<tr>
										...
										<td><input id="linkman1" name="linkman1" type="text"
											value="${contact.linkman1 }" class="credit validate[custom[onlyUnSpecial]]" /></td>
									</tr>
									<tr>
										<th>关系：</th>
									...
									<tr>
										...
										<td><input type="text" value="${contact.other1 }"
											id="other1" name="other1" class="credit validate[custom[onlyUnSpecial]]" /></td>
									</tr>
									<tr>
										<th>第二联系人：</th>
									...
									<tr>
										...
										<td><input type="text" value="${contact.other2 }"
											id="other2" name="other2" class="credit validate[custom[onlyUnSpecial]]" /></td>
									</tr>
								</tbody>
							</table>
							<c:if
