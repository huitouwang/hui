					...
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="../resources/images/vipseversicon.png" /></span>通过提交您的详细个人资料，p2p网将进行初步审核。
							</h1>
						</div>
								...
								<table cellpadding="0" cellspacing="0" border="0"
									...
									<tbody>
										...
										<tr height="35">
											...
											<td style="padding-left: 5px;" id="realname">${userbasic.name }</td>
											<input type="hidden" name="realName" value="${userbasic.name}" />
										</tr>
										<tr height="35">
											...
											<input type="hidden" id="isCard" name="isCard" value="${userbasic.userrelationinfo.cardId }" />
										</tr>
										<tr height="35">
										...
										<tr height="35">
											...
											<input type="hidden" name="phone" value="${userbasic.userrelationinfo.phone}" />
										</tr>
										<tr height="35">
										...
										<tr height="100">
											...
											<td style="border: 0px;" ><textarea cols="70" rows="8"
													class="descri validate[custom[onlyUnSpecial]]" id="remark" name="remark">${borrower.remark }</textarea></td>
										</tr>
									</tbody>
								</table>
