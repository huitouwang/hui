...
<h1 class="vipContTitle"><span><img src="../resources/images/vipseversicon.png" /></span>通过提交您的单位资料，p2p网将进行初步审核。</h1>
</div>
...
<table cellpadding="0" cellspacing="0" border="0" class="creditData">
 <tbody>
                      ...
                      <tr height="35">
                        ...
                        <td style=" padding-left:5px;"><input id="companyName" name="companyName" type="text" value="${company.companyName }" class="credit validate[custom[onlyUnSpecial]]" /></td>
                      </tr>
                      <tr height="35">
                      ...
                      <tr height="35">
                        ...
                        <td style=" padding-left:5px;"><input id="address" name="address" type="text" value="${company.address }" class="credit validate[custom[onlyUnSpecial]]" style="width:430px;" /></td>
                      </tr>
                      <tr height="35">
                      ...
                      <tr height="35">
                        ...
                        <td style=" padding-left:5px;"><input id="referenceMan" name="referenceMan" type="text" value="${company.referenceMan }" class="credit validate[custom[onlyUnSpecial]]" style="width:110px;" /></td>
                      </tr>
                      <tr height="35">
