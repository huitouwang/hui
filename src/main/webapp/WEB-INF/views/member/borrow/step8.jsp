					...
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="../resources/images/vipseversicon.png" /></span>通过提交您的审核记录，p2p网将进行初步审核。
							</h1>
						</div>
						<form>
							...
							<tr height="30">
								...
								<td align="center">
								${enum_auditresult_type[borrower.auditResult]}
								</td>
								<td align="center">
								${enum_auditstatus_type[borrower.auditStatus]}
								</td>
