...
<h1 class="vipContTitle"><span><img src="/resources/images/vipseversicon.png" /></span>温馨提示：</h1>
<p>1、p2p网规定客户设置的提现账户名，必须与其在p2p网进行实名认证时身份证的名字相同。即提现的银行账户必须是客户本<br/>&nbsp;&nbsp;&nbsp;&nbsp;人账户。</p>
<p>2、为遵守国家反洗钱和套现行为的相关法律规定，p2p网不支持信用卡提现。</p>
<p>3、p2p网处理提现时间：周一至周五，上午11：00 处理一次，下午16：00处理一次。双休日和法定节假日期间，用户可以<br/>&nbsp;&nbsp;&nbsp;&nbsp;申请提现，p2p网会在最近一个工作日进行处理。</p>
<p>4. 为防止货币资源的闲置造成额外的成本开支，会员用户在成功充值15天之内提现，p2p网会对提现金额中未投标部分收取0.5%<br/>&nbsp;&nbsp;&nbsp;&nbsp;的费用。会员用户在成功充值15天以后提现的，对提现金额中未投标部分收取0.3%的费用。 </p>
...
<table cellpadding="0" cellspacing="0" border="0" class="vipPwdManage">
 <tbody>
  <tr><th>您的p2p网帐号:</th><td>${user.userName}</td></tr>
  <tr><th>您账户可用余额:</th><td><fmt:formatNumber value="${user.userfundinfo.money}" type="currency"/>元</td></tr>
  <tr><th>提现金额:</th><td><input name="money" type="text" class="vipTextBox validate[required,custom[integerNullZero],max[${user.userfundinfo.money}]]" style="width:120px;"/> 元</td></tr>
 <tr>
	<th>提现手续费:</th>
	<td><span style="color:#fd8419">￥3.00元(由第三方托管平台收取)</span></td>
</tr>
<tr>
	<td colspan="2" align="center"><span style="color: #cb5c3e;">注意:若提现金额中有未投标部分，该部分将会收取一定的费用</span></td>
</tr>
 </tbody>
</table>
<div class="tableSetBntBox"><input type="submit" value="提交" /> <input type="reset" value="取消" /></div>
</form>
<br />
<br />
<br />
...
<h2 class="vipContTitle"><span><img src="/resources/images/vipsevers_03.jpg" /></span>注意:</h2>
