				...
				<div class="vipRightBox">
					...
					<div class="vipContBox">
						<div class="vipContTitleBox">
							...
							<p>尊敬的p2p网用户，以下是您的充值信息，请您仔细审阅</p>
							<p>
								截止<font>${cur_date}</font> 您的总计充值金额是<font><fmt:formatNumber value="${total}" type="currency"/></font>
							</p>
						</div>
							...
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<tbody>
									<c:forEach items="${list}" var="recharge" varStatus="no">
										<tr>
											<td>${no.index+1}</td>
											<td><fmt:formatNumber value="${recharge.rechargeAmount}" type="currency"/></td>
											<td><fmt:formatNumber value="${recharge.reAccount}" type="currency"/></td>
