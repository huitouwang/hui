			...
			<div class="vipContentBox">
				...
				<div class="vipRightBox">
					...
					<div class="vipContBox">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="resources/images/vipseversicon.png" /></span>尊敬的p2p网用户，以下内容是您在p2p网的系统消息，敬请仔细审阅。
							</h1>
						</div>
						<table cellpadding="0" cellspacing="0" border="0"
							...
							<thead>
								...
								<tr>
									<td colspan="5">未读 <font class="red bold" id="unreadinfos">${messagecount}</font>
										封，已读 <font class="red bold" id="readinfos">${read}</font> 封，共 <font
										class="red bold">${count}</font> 封
										<input type="hidden" value="${messagecount}" id="unReads" />
									</td>
								</tr>
							</thead>
							<tbody>
					...
					<div class="vipContBox" style="display: none;">
						<div class="vipContTitleBox">
							<h1 class="vipContTitle">
								<span><img src="/resources/images/vipseversicon.png" /></span>尊敬的p2p网用户，p2p网为您记录和保存了您的登录记录(最后登陆10次)，敬请审阅。
							</h1>
						</div>
						<table cellpadding="0" cellspacing="0" border="0"
						...
						$.ajax({
							...
							success:function(data){
								if(data){
									...
									if(unReads==0){
										$(".topIcon_5").html("<font>消息</font><font class='colorRed'>("+unReads+")</font>");
									}else{
										$(".topIcon_5").html("<font class='blink' >消息</font><font class='colorRed'>("+unReads+")</font>");
									}
								}
							}
						});
