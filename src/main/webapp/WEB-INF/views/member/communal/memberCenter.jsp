      ...
      <div class="vipRightBox">
        <div class="vipBasicInfoBox">
         <table cellpadding="0" cellspacing="0" class="basicTabIn">
          <tr><th>账户资金总额</th></tr><tr><td><font><fmt:formatNumber value="${user.userfundinfo.money+toBeClosed+interestToBe-colltionPrinInterest+lentBid-overude}" type="currency" /></font>元</td></tr>
          <tr><th>可用金额</th></tr><tr><td><font><fmt:formatNumber value="${user.userfundinfo.money}" type="currency"/></font>元</td></tr>
          <tr><th>冻结金额</th></tr><tr><td><font><fmt:formatNumber value="${lentBid}" type="currency"/></font>元</td></tr>
          <tr><th>预计账户总收益</th></tr><tr><td><font><fmt:formatNumber value="${interestToBe}" type="currency"/></font>元</td></tr>
         </table>
         <table cellpadding="0" cellspacing="0" class="basicTabIn">
          <tr><th>已得收益</th></tr><tr><td><font><fmt:formatNumber value="${netInterest}" type="currency"/></font>元</td></tr>
          <tr><th>待收收益</th></tr><tr><td><font><fmt:formatNumber value="${interestToBe}" type="currency"/></font>元</td></tr>
          <tr><th>待收本金</th></tr><tr><td><font><fmt:formatNumber value="${toBeClosed}" type="currency"/></font>元</td></tr>
          <tr><th>奖励金额</th></tr><tr><td><font><fmt:formatNumber value="${user.userfundinfo.bonusBalance}" type="currency"/></font>元</td></tr>
         </table>
         <table cellpadding="0" cellspacing="0" class="basicTabIn" style="margin:0px;">
          <tr><th>累计已出借总额</th></tr><tr><td><font><fmt:formatNumber value="${totalInvest}" type="currency"/></font>元</td></tr>
          <tr><th>待确认充值</th></tr><tr><td><font><fmt:formatNumber value="${toRecharge}" type="currency"/></font>元</td></tr>
          <tr><th>待确认提现</th></tr><tr><td><font><fmt:formatNumber value="${toWithdraw}" type="currency"/></font>元</td></tr>
          <tr><th>提现处理中</th></tr><tr><td><font><fmt:formatNumber value="${toWithdraw}" type="currency"/></font>元</td></tr>
         </table>
         <div class="clear"></div>
        </div>
        ...
        <table cellpadding="0" cellspacing="0" class="vipRecordTab">
         <thead><tr><td colspan="6">借款记录<a href="<%=basePath%>borrower_record/toRecord">[明细]</a></td></tr></thead>
         <tbody>
          <tr>
          	<th>发标中借款</th>
          	<th>偿还中借款</th>
