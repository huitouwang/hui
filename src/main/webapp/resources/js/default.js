...
//排行
$(function(){
	$(".randboxli_ph .randboxli_titli").hover(function(){
		var i = $(this).index();
		$(".randboxli_ph .randboxli_titli").removeClass("active").eq(i).addClass("active");
		$(".phlist").removeClass("active").eq(i).addClass("active");
	});
});
