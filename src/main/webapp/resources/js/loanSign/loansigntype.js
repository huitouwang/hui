   ...
   /**
	...
	$("#editloansigntype").click(function(){
		...
		if(selections==null || selections=="" || selections==undefined || selections.length!=1){
			...
			$.pdialog.open("/loansigntype/seeDetails?id="+selections[0].id, 'addloansigntype', '修改标的类型' , { width:550,height:380,mask:true,maxable:false });
		}
	});
