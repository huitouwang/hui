...
public class VisitorController {
    ...
    public String initIndex(HttpServletRequest request){
		...
		List<UserRank> totalRankList = loanRecordService.getTotalRank();
		
		List<UserRank> monthRankList = loanRecordService.getMonthRank();
		
		List<UserRank> weeklRankList = loanRecordService.getWeekRank();
		//总排行
		...
		//周排行
		request.setAttribute("weeklRankList", weeklRankList);
