...
public class WithdrawController {
	...
	@CheckFundsSafe
	public String openWithdraw(HttpServletRequest request,
		...
		request.setAttribute("user",
				userInfoServices.queryBasicsInfoById(u.getId().toString()));
	...
	public String ipsWithdraw(String money, String code,
		...
		Userbasicsinfo user = userInfoServices.queryBasicsInfoById(userbasic
				.getId().toString());
		...
		// 插入提现记录表
		Boolean isSucc = processingService.withdrlwal(withdraw, userbasic);
		...
		if(isSucc){
			...
			request.setAttribute("error", "提现失败，请联系客服");
