...
public class UserInfoVipController {
	...
	private static final Logger LOGGER = Logger.getLogger(UserInfoVipController.class);
	...
	public String sign(PaymentReturnInfo returnInfo,HttpServletRequest request){
		...
		System.out.print("start sign...");
		
		LOGGER.debug("start deal sign...");
		
		LOGGER.debug("returnInfo:"+returnInfo.getSucc());
		
		LOGGER.debug(request.getAttribute("succ"));
