...
public class WithdrawAdminService {
	...
	public List queryPage(PageModel page, String beginDate, String endDate,
		...
		String sql = "SELECT a.id,b.name,b.userName,a.withdrawAmount,"
				+ "a.deposit,a.strNum,a.pIpsBillNo,a.time,a.remark,a.withdrawstate  "
				+ "FROM withdraw a,userbasicsinfo b WHERE " + "a.user_id=b.id"
				+ connectionSql(beginDate, endDate, userName)
				+ " ORDER BY a.applytime DESC LIMIT " + page.firstResult()
				+ "," + page.getNumPerPage();
	...
	public List queryById(String ids) {
		StringBuffer sql = new StringBuffer(
				"SELECT a.id,b.name,b.userName,ROUND(a.withdrawAmount,2),"
						+ "ROUND(a.deposit,2),a.strNum,a.pIpsBillNo,a.time,a.remark,a.user_id,a.withdrawstate "
	 ...
	 * @return
	 */
	public Boolean checkPass(String id, String amt, String user_id) {

		Boolean bool = dao.callProcedureVoid(
				Enums.PROCEDURES.PROCEDURE_WITHDRAWAL_PASS.toString(), id, amt,
				user_id);
