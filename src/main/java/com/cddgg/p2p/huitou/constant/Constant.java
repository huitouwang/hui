 ...
 *
 */
public interface Constant extends com.cddgg.base.constant.Constant {
    ...
    /**投标*/
    String BID = WEB_URL+"plank/returnBid.htm";
    String ASYNCHRONISMBID = WEB_URL+"processing/asynchronismBid.htm";
    /**放款*/
    String LOANS = WEB_URL+"processing/loans.htm";
    /**流标*/
    String FLOWSTANDARD = WEB_URL+"processing/getFlowStandard.htm";
    /**
     * 债权匹配锁定时间
     */
     ...
     * PROJECT_NAME
     */
    String PROJECT_NAME = "p2p网贷平台";
    /**
     * SYSTEM_EXCEPTION_RECEIVE
     */
    String[] SYSTEM_EXCEPTION_RECEIVE = {"1014368409@qq.com"};
    ...
    String IPS_RECHARGES = "";
    String IPS_WITHDRAW = "5";
}
